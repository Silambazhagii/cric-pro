...
function fetch_data(data) {
  if (foodResults.length > 0) {
    ...
    ingredients.addEventListener('click', () => {
      openModal(name, imageSrc, foodResults[resultIndex].idMeal);
    });
  } else {
...
function displayPopup(meal) {
  ...
  popupText.textContent = `Ingredients for ${meal.strMeal}: ${meal.strIngredient1}, ${meal.strIngredient2}, ${meal.strIngredient3}, ${meal.strIngredient4}`;
